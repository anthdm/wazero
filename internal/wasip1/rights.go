...
const (
	...
	// RIGHT_SOCK_ACCEPT it the right to invoke sock_accept
	RIGHT_SOCK_ACCEPT

	// RIGHT_ALL is the set of all available rights
	RIGHT_ALL = (1 << 30) - 1

	// RIGHT_READ are rights related to reads.
	RIGHT_READ = RIGHT_FD_READ | RIGHT_FD_READDIR

	// RIGHT_WRITE are rights related to writes.
	RIGHT_WRITE = RIGHT_FD_WRITE | RIGHT_FD_ALLOCATE | RIGHT_PATH_FILESTAT_SET_SIZE | RIGHT_FD_DATASYNC

	RIGHT_SYNC = RIGHT_FD_SYNC | RIGHT_FD_DATASYNC

	RIGHT_SEEK = RIGHT_FD_SEEK | RIGHT_FD_TELL

	RIGHT_FILE_STAT = RIGHT_FD_FILESTAT_GET | RIGHT_FD_FILESTAT_SET_SIZE | RIGHT_FD_FILESTAT_SET_TIMES

	RIGHT_PATH = RIGHT_PATH_CREATE_DIRECTORY |
		RIGHT_PATH_CREATE_FILE |
		RIGHT_PATH_LINK_SOURCE |
		RIGHT_PATH_LINK_TARGET |
		RIGHT_PATH_OPEN |
	...
	RIGHT_DIRECTORY = RIGHT_PATH | RIGHT_SYNC | RIGHT_FILE_STAT | RIGHT_FDSTAT_SET_FLAGS | RIGHT_FD_READDIR
	...
	RIGHT_SOCK_LISTEN = RIGHT_SOCK_ACCEPT | RIGHT_POLL_FD_READWRITE | RIGHT_FD_FILESTAT_GET | RIGHT_FDSTAT_SET_FLAGS

	RIGHT_SOCK_CONNECT = RIGHT_FD_READ |
		RIGHT_FD_WRITE |
		RIGHT_POLL_FD_READWRITE |
		RIGHT_SOCK_SHUTDOWN |
		RIGHT_FD_FILESTAT_GET |
